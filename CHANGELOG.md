...
- No em-dash and no emoji in the product's content (ADR-0067): 1,339 lines across the site, the package, the docs
  and the tests; the data records and manifests keep their text. The archetype's content guard runs in CI.
