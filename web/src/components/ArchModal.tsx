...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    body: {
      ...
      es: "Dónde se ejecuta cada pieza de trabajo. El carril web re-simula circuitos unitarios pequeños y limpios en vivo en el navegador con un motor de statevector exacto escrito a mano (Qiskit no puede ejecutarse en el navegador — sin wheels de Pyodide). El carril offline ejecuta los motores reales pesados (Qiskit+Aer, PennyLane, Cirq, Stim) en un .venv local cuando un caso necesita ruido, feed-forward, un loop de optimización o >12 qubits, y versiona una traza con semilla + manifiesto. El carril cómputo (inactivo, opcional, solo local) puede reproducir un trabajo de QPU real. Los tres emiten una sola forma de artefacto, así que la SPA estática anima cualquiera por un único render — 'vivo' es responder al slider, no otro modelo.",
    },
